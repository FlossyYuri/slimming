  ...
  return (
    <div className='flex items-center justify-center h-screen p-4'>
      <div className='p-1 rounded shadow-lg bg-gradient-to-r from-purple-500 via-green-500 to-blue-500'>
        <div className='flex flex-col items-center p-4 space-y-2 bg-white text-center'>
          <svg
          ...
          <p>
            Obrigado pela compra! <br /> Por favor abra o seu email para receber
            as instruções de como adquirir o seu produto!
          </p>
          <Link href='/'>
